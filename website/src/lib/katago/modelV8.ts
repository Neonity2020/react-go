// KataGo V8 model — TF.js inference graph
...
type TfMatMul = { inChannels: number; outChannels: number; w: tf.Tensor2D };
type TfMatBias = { channels: number; b: tf.Tensor2D };

// --- Parsed model types (shared with loadModel.ts) ---
...
// --- TF.js tensor construction helpers ---
